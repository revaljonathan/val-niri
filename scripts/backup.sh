...
cp ~/.local/bin/{tl.sh,filerofi.sh,powermenu.sh,sleep.sh,dynalock.sh,dunstvol.sh,dunstback.sh,wifi.sh,steam.sh,browse.sh,barsel.sh,bat.sh,mem.sh,weather.sh,ss.sh,backup.sh,playerctl.sh,media.sh,ppd.sh,control.sh,dunst.sh,record.sh,dnd-toggle.sh,rng.sh,wall.sh,cal.sh,yazi-note.sh,wayppd.sh,wayvol.sh,wayback.sh} ~/code/val-niri/scripts/
