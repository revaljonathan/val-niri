    ...
    QtObject {
        readonly property real bgAlpha: 0.90
        ...
        readonly property color containerHighest: Qt.alpha("{{colors.surface_container_high.default.hex}}", bgAlpha)
        ...
        readonly property color forceblue: "{{colors.primary.default.hex | lighten: -7 | set_hue: 187}}"
